...
class GRssFeed extends ComponentAbstract
{
    public $cssClass;
    public $title;
    public $subtitle;
    ...
    {
        return [
            'name'        => 'gemfourmedia.gcontent::lang.components.gRssFeed.name',
            'description' => 'gemfourmedia.gcontent::lang.components.gRssFeed.desc'
        ];
    }
    ...
    public function prepareVars()
    {
        ...
        $this->page['link'] = $this->pageUrl($this->listPage);
