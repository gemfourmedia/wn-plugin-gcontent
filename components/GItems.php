...
class GItems extends ComponentAbstract
{
    public $cssClass;
    public $title;
    public $subtitle;
    ...
    {
        return [
            'name'        => 'gemfourmedia.gcontent::lang.components.gItems.name',
            'description' => 'gemfourmedia.gcontent::lang.components.gItems.desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'setPageMeta' => [
                'title' => 'gemfourmedia.gcontent::lang.components.gItems.props.setPageMeta',
                'description' => 'gemfourmedia.gcontent::lang.components.gItems.props.setPageMeta_desc',
                'type' => 'dropdown',
                'default' => '',
                'showExternalParam' => false,
            ],
    ...
    public function getSetPageMetaOptions()
    {
        return [
            '' => 'Don\'t set',
            'category' => 'By Category\'s Meta tags',
            'group' => 'By Group\'s Meta tags',
            'serie' => 'By Serie\'s Meta tags',
        ];
    }
    ...
    public function onRun()
    {
        ...
        $pageMetaType = $this->property('setPageMeta');

        if ($pageMetaType && isset($this->{$pageMetaType})) {
            $this->setPageMeta($this->{$pageMetaType});
        }
    ...
    public function onPaginate()
    {
        ...
        $this->page['pageNumber'] = post('page');

        $this->page['items'] = $this->loadItems();

        return [
            '#'.$this->alias.'__body' => $this->renderPartial($this->alias.'::_list'),
            '#'.$this->alias.'__pagination' => $this->renderPartial($this->alias.'::_pagination_ajax'),
        ];
    }
